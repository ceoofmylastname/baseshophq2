...
export function useScoreboardTopProducers(args: {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(realtimeTopic(`scoreboard-producers-${tenant.id}`))
      .on("postgres_changes",
